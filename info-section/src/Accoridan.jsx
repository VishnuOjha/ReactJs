...
import wiki from "./images/wikipedia-logo.svg";
import web from "./images/globe .svg";
    ...
    <div className="wrapper">
      ...
      <div className="company-description">
        <p>
          ...
          sells consumer electronics, computer software, and online services. It
          is considered one of the Big Five companies in the U.S. information
          technology industry, along with Amazon, Google, Microsoft, and
          Facebook. Its hardware products include the iPhone smartphone, the
          iPad tablet computer, the Mac personal computer, the iPod portable
          media player, the Apple Watch smartwatch, the Apple TV digital media
          player, the AirPods wireless earbuds, the AirPods Max headphones, and
          the HomePod smart speaker line. Apple's software includes iOS, iPadOS,
          macOS, watchOS, and tvOS operating systems, the iTunes media player,
          the Safari web browser, the Shazam music identifier, and the iLife and
          iWork creativity and productivity suites, as well as professional
          applications like Final Cut Pro X, Logic Pro, and Xcode <br />
        ...
        {!isOpen && (
          <div className="accordian-content">
            ...
            <div className="company-trad">
              <span>Traded as:</span>NASDAQ: aapl AAPL, NASDAQ-100 component,
            ...
            <div className="company-industry-type">
              ...
              Fabless silicon design, Semiconductors, Media, Retail, Financial
              technology
            </div>
